...
class Ui_dveWindow(object):
    def setupUi(self, dveWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resource_path("img"+os.sep+"logo-ico.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label.setPixmap(QtGui.QPixmap(resource_path("img"+os.sep+"logo.png")))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(resource_path("img"+os.sep+"gear.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(resource_path("img"+os.sep+"i.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(resource_path("img"+os.sep+"search.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
