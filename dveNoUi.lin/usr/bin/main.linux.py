...
from PyQt6.QtCore import Qt, pyqtSignal, QEvent, QTimer, QUrl, QCoreApplication
...
class Confgui(QDialog, Ui_FormSettings):
    ...
    def lineColChange(self, text):
        ...
        if self.check_color(text) is True:
            ...
            if source == "lineCol1":
                self.color1Button.setIcon(QIcon(HERE+"/../share/img/stop.png"))
                self.color1Button.setStyleSheet("background-color:white;")
                self.threeColorsGood()
            elif source == "lineCol2":
                self.color2Button.setIcon(QIcon(HERE+"/../share/img/stop.png"))
                self.color2Button.setStyleSheet("background-color:white;")
                self.threeColorsGood()
            elif source == "lineFontCol":
                self.fontColorButton.setIcon(QIcon(HERE+"/../share/img/stop.png"))
...
home_dir = Path.home()
HOME = str( home_dir )+"/"
HERE_File = sys.argv[0]
HERE = HERE_File.rsplit("/",1)[0]
...
def checkExternalFiles():
    files = {
        # "img/stop.png" : HOME+".local/share/dve/img/stop.png",
        # "img/search.png" : HOME+".local/share/dve/img/search.png",
        # "img/logo.png" : HOME+".local/share/dve/img/logo.png",
        # "img/logo-ico.png" : HOME+".local/share/dve/img/logo-ico.png",
        # "img/i.png" : HOME+".local/share/dve/img/i.png",
        # "img/gear.png" : HOME+".local/share/dve/img/gear.png",
        HERE+"/../share/config/config.json" : HOME+".config/dve/config.json",
        #check temp dir
        HERE+"/../share/temp/" : HOME+".config/dve/temp/",
        #check themes dir
        HERE+"/../share/themes/" : HOME+".config/dve/themes/",
    }
...
def createExternalFile(inpath, expath):
    if inpath == HERE+"/../share/temp/" or inpath == HERE+"/../share/themes/":
        src = inpath
        dst = expath
...
def main():
    ...
    if tray == "True":
        ...
        icon = QIcon(HERE+"/../share/img/logo-ico.png")
