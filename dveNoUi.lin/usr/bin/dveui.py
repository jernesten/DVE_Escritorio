...
class Ui_dveWindow(object):
    def setupUi(self, dveWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(HERE+"/../share/img/logo-ico.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label.setPixmap(QtGui.QPixmap(HERE+"/../share/img/logo.png"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(HERE+"/../share/img/gear.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(HERE+"/../share/img/i.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(HERE+"/../share/img/search.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
